...
- **Biblioteca (último botão da esquerda):** móveis, eletros, portas e janelas em tamanho real, por ambiente, com busca. No topo da biblioteca, escolha "Visto de cima" ou "Visto de frente": é esse desenho que entra, em qualquer folha. A peça fica centrada onde você tocar; colada numa parede, encosta e gira sozinha; porta e janela entram na parede e pegam a espessura dela.
